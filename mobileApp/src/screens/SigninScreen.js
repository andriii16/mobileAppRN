...
const SigninScreen = ({navigation}) => {
    ...
    try {
      ...
      if (response?.status) {
        ...
        if (userDataResponse?.status) {
          dispatch(GeneralAction.setUserData(userDataResponse.data));
          // const profileImage =
          //   userDataResponse.data.profileImage || Images.AVATAR;
          // dispatch(GeneralAction.setProfileImage(profileImage));
        } else {
          setErrorMessage(
            userDataResponse?.message ||
              "Greška pri preuzimanju podataka o korisniku",
          );
        }
      } else {
        setErrorMessage(response?.message);
  ...
  //         style={{paddingTop: 10}}
  //       />
  //       <Text style={styles.headerTitle}>Prijavite se</Text>
  //     </View>
  //     <Text style={styles.title}>Dobro došli</Text>
  //     <Text style={styles.content}>
  //       Unesite svoje korisničko ime i lozinku i učinite voljene ljude srećnim.
  //     </Text>
  ...
  //       ) : (
  //         <Text style={styles.signinButtonText}>Prijavite se</Text>
  //       )}
  //     </TouchableOpacity>
  ...
  //           Prijavite se sa Facebook nalogom
  //         </Text>
  //       </View>
  //     </TouchableOpacity>
