  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        />
        <Text style={styles.headerTitle}>Sačuvano</Text>
      </View>
      <FlatList
        ...
        renderItem={({item}) => (
          <BookmarkCard
            ...
            id={item["flower shop"]?.id}
            name={item["flower shop"]?.name}
            images={item["flower shop"]?.images}
            location={item["flower shop"]?.location}
            tags={item["flower shop"]?.tags}
            navigate={shopId => navigation.navigate("Shop", {shopId})}
          />
        )}
      />
