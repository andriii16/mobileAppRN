    ...
    <ImageBackground
      ...
      <View style={styles.headerContainer}>
        <Ionicons
          ...
          style={{paddingTop: 10}}
        />
        <Text style={styles.headerTitle}>Registrujte se</Text>
      </View>
      <Text style={styles.title}>Napravite nalog</Text>
      <Text style={styles.content}>
        Unesite svoj email, izaberite korisničko ime i lozinku
      </Text>
      ...
      <TouchableOpacity
        ...
        {isLoading ? (
          ...
          <Text style={styles.signinButtonText}>Napravite nalog</Text>
        )}
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.facebookButton}>
        <View style={styles.socialButtonsContainer}>
          ...
          <Text style={styles.socialSigninButtonText}>
            Registrujte se sa Facebook nalogom
          </Text>
        </View>
      </TouchableOpacity>
