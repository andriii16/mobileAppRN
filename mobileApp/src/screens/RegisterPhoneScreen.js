...
const RegisterPhoneScreen = ({navigation}) => {
  const [selectedCountry, setSelectedCountry] = useState(
    CountryCode.find(country => country.name === "Montenegro"),
  );
    ...
    <View
      ...
      <View style={styles.headerContainer}>
        <Ionicons
          ...
          style={{paddingTop: 10}}
        />
        <Text style={styles.headerTitle}>Registracija broja telefona</Text>
      </View>
      <Text style={styles.title}>Registrujte broj telefona</Text>
      <Text style={styles.content}>
        Unesite svoj broj telefona kako biste se prijavili.
      </Text>
      <View
      ...
      <TouchableOpacity
        ...
        <Text style={styles.signinButtonText}>Nastavite</Text>
      </TouchableOpacity>
      {isDropdownOpen && (
        <View
