...
const ShopMediumCard = ({name, images: {logo}, time, distance, tags}) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.labelContainer}>
        ...
        <Text style={styles.tagsText}>{tags?.slice(0, 4).join(" • ")}</Text>
        <View style={styles.deliveryDetailsContainer}>
          <View style={styles.rowAndCenter}>
            ...
            />
            <Text style={styles.deliveryDetailsText}>Besplatna isporuka</Text>
          </View>
          <View style={styles.rowAndCenter}>
            <Image
